...
# Datasets root resolved relative to this file (TRANSFORMER/ -> submission_123/ -> Datasets/)
...
def parse_args():
    ...
    # Audio length modification arguments -- these arent guaranteed to work, please use the audio augmentation offline script.
...
class TrainingConfig:
    def __init__(self):
        # Data settings — Al-Emadi has yes_drone/unknown at root level (transformer uses its own loader)
        self.data_dir = str(_DATASETS_ROOT / "Al-Emadi")
