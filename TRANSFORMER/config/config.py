...
# Models directory: TRANSFORMER/config/ -> TRANSFORMER/ -> submission_123/ -> Models/
_MODELS_ROOT = Path(__file__).resolve().parent.parent.parent / "Models"
_DEFAULT_MODEL_PATH = str(_MODELS_ROOT)


@dataclass
class ModelConfigForEval:
    """Configuration for model paths and basic settings. This is for eval only"""
    # Default points to submission_123/Models; override with a specific checkpoint subdir or --model-path arg
